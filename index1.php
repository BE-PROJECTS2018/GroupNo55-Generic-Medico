...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="img/header-bg (2).jpg" alt="Mountain View" width="200" height="180"></a>
...
fa-stack-1x fa-inverse"></i>
            ...
            <h4 class="service-heading"><a href="searchsec.html">Search The Generic</a></h4>
          ...
          <div class="col-md-4">
            ...
            <h4 class="service-heading"><a href="updated bot.html">ChatBot/Take Appointment</h4>
            <p class="text-muted">Here You can get information about the medicine from a doctor who is a registered user. Users can chat easily with doctors on our website about the medicines required </p>
          </div>
        </div>
      </div>
    </section>   <!-- References -->
